...
def part_one():
    ...
    # Much more efficient to maintain a sorted list as we build it, as opposed to sorting at the end
...
def part_two():
    ...
    # Again, consider the best data structure to answer the question as we're building the 'list'
